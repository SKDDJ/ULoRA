...
while true; do
    for ((gpu_id=0; gpu_id<8; gpu_id++)); do
        ...
        # echo "Running on GPU $gpu_id with learning rate $learning_rate"
            ...
            precision="fp16"
            export WANDB_NAME=woman-loldu-diffusion
            output_dir="/root/shiym_proj/Sara/Evaluation/diffusion/lora_dreambooth/outputs/$precision-727"
            ...
            CUDA_VISIBLE_DEVICES=$gpu_id accelerate launch --mixed_precision=$precision train_dreambooth.py \
                ...
                --instance_data_dir="./datasets/woman" \
                ...
                --validation_prompt="a photo of sks girl in Times Squares" \
