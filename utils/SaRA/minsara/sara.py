...
class SaRAParametrization(pl.LightningModule):
    ...
    @classmethod
    def from_linear(cls, layer, rank=4, lora_dropout_p=0.0, lora_alpha=1, init_sara_weights="fast_niter_8"):
        fan_out, fan_in = layer.weight.shape        
        return cls(
            fan_in, fan_out, fan_in_fan_out=False, rank=rank, lora_dropout_p=lora_dropout_p, lora_alpha=lora_alpha, layer_module=layer, init_sara_weights=init_sara_weights
        )

    @classmethod
    def from_conv2d(cls, layer, rank=4, lora_dropout_p=0.0, lora_alpha=1, init_sara_weights="fast_niter_8"):
    ...
    @classmethod
    def from_embedding(cls, layer, rank=4, lora_dropout_p=0.0, lora_alpha=1, init_sara_weights="fast_niter_8"):
        fan_in, fan_out = layer.weight.shape
        return cls(
            fan_in, fan_out, fan_in_fan_out=True, rank=rank, lora_dropout_p=lora_dropout_p, lora_alpha=lora_alpha, layer_module=layer, init_sara_weights=init_sara_weights
        )
